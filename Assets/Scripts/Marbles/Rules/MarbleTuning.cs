...
namespace MarblesECS
{
    ...
    public sealed class MarbleTuning
    {
        ...
        public float MassPerBlood = 0.1f;
        public uint MarbleDefinitionId = 1;
        public double BaseScore = 10d;
        public double BaseRushChance;
        public float BloodCostMultiplier = 1f;
        public float FireIntervalSeconds = 0.15f;
        public float LaunchSpeed = 12f;
        public float LauncherScoreMultiplier = 1f;
        public int MaxActiveMarbles = 256;
        public float MaxLifeSeconds = 45f;
